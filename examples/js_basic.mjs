#!/usr/bin/env node
/**
 * PomaiDB JavaScript FFI example (Node.js + ffi-napi).
...
// pomai_options_t — padding before `path` (64-bit) and after `index_type` (uint8)
...
// pomai_query_t — padding before `vector` pointer
