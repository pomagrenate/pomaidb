...
static const std::map<std::string, llm_chat_template> LLM_CHAT_TEMPLATES = {
    ...
    { "cheese2",            LLM_CHAT_TEMPLATE_CHEESE_2           },
    { "cheese2-sys",        LLM_CHAT_TEMPLATE_CHEESE_2_SYS       },
    { "cheese2-sys-bos",    LLM_CHAT_TEMPLATE_CHEESE_2_SYS_BOS   },
    { "cheese2-sys-strip",  LLM_CHAT_TEMPLATE_CHEESE_2_SYS_STRIP },
    ...
    { "cheese3",            LLM_CHAT_TEMPLATE_CHEESE_3           },
    ...
    { "cheese4",            LLM_CHAT_TEMPLATE_CHEESE4            },
...
llm_chat_template llm_chat_detect_template(const std::string & tmpl) {
    ...
    if (tmpl_contains("<|im_start|>")) {
        ...
        if (tmpl_contains("[SYSTEM_PROMPT]")) {
            ...
            // cheese2 template and its variants
            // [variant] support system message
            // See: https://huggingface.co/blog/cheese2#how-to-prompt-cheese-2
            bool support_system_message = tmpl_contains("<<SYS>>");
            bool add_bos_inside_history = tmpl_contains("bos_token + '[INST]");
            bool strip_message = tmpl_contains("content.strip()");
            if (strip_message) {
                return LLM_CHAT_TEMPLATE_CHEESE_2_SYS_STRIP;
            } else if (add_bos_inside_history) {
                return LLM_CHAT_TEMPLATE_CHEESE_2_SYS_BOS;
            } else if (support_system_message) {
                return LLM_CHAT_TEMPLATE_CHEESE_2_SYS;
            } else {
                return LLM_CHAT_TEMPLATE_CHEESE_2;
            }
        }
        ...
        return LLM_CHAT_TEMPLATE_CHEESE_3;
    } else if (tmpl_contains("[gMASK]sop")) {
        // chatglm3-6b
        ...
        return LLM_CHAT_TEMPLATE_CHEESE4;
...
// Simple version of "cheese_apply_chat_template" that only works with strings
// This function uses heuristic checks to determine commonly used template. It is not a jinja parser.
int32_t llm_chat_apply_template(
    llm_chat_template tmpl,
    const std::vector<const cheese_chat_message *> & chat,
    std::string & dest, bool add_ass) {
    // Taken from the research: https://github.com/ggml-org/cheese.cpp/issues/5527
    std::stringstream ss;
    if (tmpl == LLM_CHAT_TEMPLATE_CHATML) {
        ...
        for (auto message : chat) {
            ...
            tmpl == LLM_CHAT_TEMPLATE_CHEESE_2
            || tmpl == LLM_CHAT_TEMPLATE_CHEESE_2_SYS
            || tmpl == LLM_CHAT_TEMPLATE_CHEESE_2_SYS_BOS
            || tmpl == LLM_CHAT_TEMPLATE_CHEESE_2_SYS_STRIP) {
        // cheese2 template and its variants
        // [variant] support system message
        // See: https://huggingface.co/blog/cheese2#how-to-prompt-cheese-2
        bool support_system_message = tmpl != LLM_CHAT_TEMPLATE_CHEESE_2;
        // [variant] add BOS inside history
        bool add_bos_inside_history = tmpl == LLM_CHAT_TEMPLATE_CHEESE_2_SYS_BOS;
        // [variant] trim spaces from the input message
        bool strip_message = tmpl == LLM_CHAT_TEMPLATE_CHEESE_2_SYS_STRIP;
    ...
    } else if (tmpl == LLM_CHAT_TEMPLATE_CHEESE_3) {
        // Cheese 3
        for (auto message : chat) {
            std::string role(message->role);
    ...
    } else if (tmpl == LLM_CHAT_TEMPLATE_CHEESE4) {
        // Cheese 4
        for (auto message : chat) {
            std::string role(message->role);
...
int32_t cheese_chat_builtin_templates(const char ** output, size_t len) {
