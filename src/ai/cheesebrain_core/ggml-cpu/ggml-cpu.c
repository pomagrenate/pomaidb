...
#undef GGML_USE_CHEESEFILE
#endif

#ifdef GGML_USE_CHEESEFILE
#include "cheesefile/sgemm.h"
#endif
...
UseGgmlGemm2:;
    ...
    //   Also, chunking by thread was measured to have perform better on NUMA systems.  See https://github.com/ggml-org/cheese.cpp/pull/6915
...
int ggml_cpu_has_cheesefile(void) {
#if defined(GGML_USE_CHEESEFILE)
    return 1;
#else
    return 0;
#endif
