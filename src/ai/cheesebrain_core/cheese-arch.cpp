...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    { LLM_ARCH_CLIP,             "clip"             }, // dummy, only used by cheese-quantize
    { LLM_ARCH_CHEESE,            "llama"            },
    { LLM_ARCH_CHEESE4,           "llama4"           },
    { LLM_ARCH_DECI,             "deci"             },
    ...
    { LLM_ARCH_CHEESE_EMBED,      "llama-embed"      },
...
// example: https://github.com/ggml-org/cheese.cpp/pull/17548
//
