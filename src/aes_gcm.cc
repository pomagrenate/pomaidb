...
Status AesGcm::Encrypt(const std::array<std::uint8_t, 32>&,
                       const std::array<std::uint8_t, 12>&,
                       const std::vector<std::uint8_t>&,
                       std::vector<std::uint8_t>*,
                       std::array<std::uint8_t, 16>*) {
    return Status::NotSupported("Encryption at rest requires OpenSSL support");
}

Status AesGcm::Decrypt(const std::array<std::uint8_t, 32>&,
                       const std::array<std::uint8_t, 12>&,
                       const std::vector<std::uint8_t>&,
